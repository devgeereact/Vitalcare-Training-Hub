...
export default function CompanyClosures(): React.JSX.Element {
  ...
  function openEdit(h: OrgHoliday): void {
    setEditId(h.id)
    setFName(h.name)
  ...
  function save(): void {
    ...
    op
      .then(() => {
        toast.success(editId ? "Closure updated" : "Closure added")
        setEditing(false)
      })
      .catch(() => toast.error("Could not save the closure"))
  }
        ...
        <CardHeader className="flex-row items-start justify-between gap-3 space-y-0">
          <div>
            ...
            <CardDescription className="mt-1">
              Days your organisation is closed or rooms are unavailable. These show on
